...
import AssignClientToProject from '@/components/admin/project-management/AssignClientToProject';

const AdminAssignClient = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Assigner un client au projet | Progineer</title>
        <meta name="description" content="Assignez un client existant à un projet dans le système Progineer." />
      </Helmet>
          ...
          <div className="flex flex-col md:flex-row md:justify-between md:items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 dark:text-gray-300 max-w-2xl mb-8">
                Associez un client existant à ce projet pour lui donner accès aux documents et au suivi.
              </p>
            </div>
...
export default AdminAssignClient;
