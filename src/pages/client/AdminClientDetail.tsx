...
const AdminClientDetail = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Détail du client | Progineer</title>
        <meta name="description" content="Gérez les détails du client et les projets associés." />
      </Helmet>
          ...
          <div className="flex flex-col md:flex-row md:justify-between md:items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 dark:text-gray-300 max-w-2xl mb-8">
                Consultez et gérez les informations du client et ses projets associés.
              </p>
            </div>
