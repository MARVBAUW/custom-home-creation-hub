...
const AdminProjects = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Gestion des projets | Progineer</title>
        <meta name="description" content="Gérez tous les projets clients dans l'espace administration." />
      </Helmet>
          ...
          <div className="flex flex-col md:flex-row md:justify-between md:items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 dark:text-gray-300 max-w-2xl mb-8">
                Créez, modifiez et attribuez des projets aux clients. Suivez l'avancement et gérez tous les aspects de vos projets.
              </p>
            </div>
