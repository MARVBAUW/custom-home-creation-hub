...
const CGU = () => {
  ...
  return (
    <>
      <SEO 
        title="Conditions Générales d'Utilisation | Progineer - Architecte & Maître d'œuvre en PACA"
        description="Consultez les Conditions Générales d'Utilisation du site Progineer, entreprise d'architecture et de maîtrise d'œuvre en région PACA."
        keywords="CGU, conditions générales utilisation, architecture PACA, règles utilisation site"
      ...
      <SEOFooter text="Conditions Générales d'Utilisation du site Progineer. Ces CGU définissent les règles d'usage de notre site internet. Notre cabinet d'architecture et de maîtrise d'œuvre intervient dans toute la région PACA pour vos projets de construction, rénovation et extension." />
    </>
  );
};
