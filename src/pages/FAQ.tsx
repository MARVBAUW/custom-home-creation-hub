      ...
      <section className="py-8 bg-stone-50 border-t border-stone-200">
        <Container>
          <div className="text-sm text-stone-500">
            <p>
              Ingénieur, maître d'œuvre à Marseille et en PACA – Spécialiste en construction de maisons sur mesure, rénovation et extension. Nos architectes et ingénieurs répondent à toutes vos questions sur vos projets immobiliers dans la région Provence-Alpes-Côte d'Azur.
            </p>
          </div>
        </Container>
      </section>
