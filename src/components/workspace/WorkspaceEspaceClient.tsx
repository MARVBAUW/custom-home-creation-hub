...
const WorkspaceEspaceClient = () => {
  ...
  return <div className="space-y-6">
      <div className="mb-8">
        ...
        {user && <div className="mt-4 bg-transparent">
            <Link to="/workspace/client-area">
              <Button className="text-white bg-[#38381d]/[0.89]">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="bg-white">
          {loading ? <div className="flex flex-col justify-center items-center py-16 bg-white rounded-xl border border-gray-200 shadow-sm">
            ...
            </div> : user ? <div className="bg-green-50 border border-green-200 rounded-xl p-6 text-green-800">
