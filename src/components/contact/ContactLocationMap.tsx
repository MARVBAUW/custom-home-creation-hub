...
const ContactLocationMap = () => {
  return (
    <section className="py-16 bg-progineer-light/50 border-t border-progineer-gold/10" id="zones-intervention">
      <Container>
        ...
        <div className="mt-10 text-center">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {locations.slice(0, 8).map((location, index) => (
              <div key={index} 
                className="p-3 bg-white rounded-lg shadow-sm border border-progineer-gold/10"
                id={location.id}
              >
