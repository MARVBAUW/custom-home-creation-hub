      ...
      <Container size="md">
        ...
        <div className="grid md:grid-cols-4 gap-6 mb-10">
          <div className="text-center p-4">
            <p className="text-4xl font-bold text-progineer-gold mb-2">+120</p>
          ...
          <div className="text-center p-4">
            <p className="text-4xl font-bold text-progineer-gold mb-2">7+</p>
            <p className="text-progineer-dark/80">Années d'expérience</p>
          </div>
          
          <div className="text-center p-4">
            <p className="text-4xl font-bold text-progineer-gold mb-2">12</p>
