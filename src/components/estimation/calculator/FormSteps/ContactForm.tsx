            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <Input 
                    id="name" 
                    value={formData.name || defaultValues?.firstName || ''} 
                ...
                <div>
                  ...
                  <Input 
                    id="email" 
                    type="email"
                    value={formData.email || defaultValues?.email || ''} 
                ...
                <div>
                  ...
                  <Input 
                    id="phone" 
                    value={formData.phone || defaultValues?.phone || ''} 
                ...
                <div className="space-y-2 pt-2">
                  <div className="flex items-center space-x-2">
                    ...
                    <Label htmlFor="agreeTerms" className="text-sm">
                      J'accepte de recevoir des informations de la part de Progineer
                    </Label>
                  </div>
                </div>
              </div>
